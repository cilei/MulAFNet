...
def parse_args():
    ...
    parser.add_argument('--lr0', default=5e-4, type=float, help="learning rate of encoder0")
    parser.add_argument('--lr1', default=5e-4, type=float, help="learning rate of encoder1")
