...
def parse_args():
    ...
    # directory arguments
    parser.add_argument('--output_dir', default='result/ESOL', type=str, help="output directory of task")
...
def process_data(args):
    tasks, datasets, transformer = dc.molnet.load_delaney(data_dir='./data/MoleculeNet', save_dir='./data/MoleculeNet',
